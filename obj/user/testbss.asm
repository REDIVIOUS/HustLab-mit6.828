...
umain(int argc, char **argv)
{
  ...
  80004b:	50                   	push   %eax
  80004c:	e8 49 02 00 00       	call   80029a <cprintf>
  ...
  8000aa:	50                   	push   %eax
  8000ab:	e8 ea 01 00 00       	call   80029a <cprintf>
  ...
  8000d2:	50                   	push   %eax
  8000d3:	e8 b6 00 00 00       	call   80018e <_panic>
			panic("bigarray[%d] isn't cleared!\n", i);
  8000d8:	50                   	push   %eax
  ...
  8000e8:	50                   	push   %eax
  8000e9:	e8 a0 00 00 00       	call   80018e <_panic>
			panic("bigarray[%d] didn't hold its value!\n", i);
  8000ee:	50                   	push   %eax
  ...
  8000fe:	50                   	push   %eax
  8000ff:	e8 8a 00 00 00       	call   80018e <_panic>
...
libmain(int argc, char **argv)
{
  ...
  80011c:	8b 7d 0c             	mov    0xc(%ebp),%edi
	// set thisenv to point at our Env structure in envs[].
	// LAB 3: Your code here.
	thisenv = 0;
  80011f:	c7 c6 40 20 c0 00    	mov    $0xc02040,%esi
  800125:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	thisenv = (struct Env*)(envs + ENVX(sys_getenvid())); //（为当前进程）初始化全局指针
  80012b:	e8 98 0b 00 00       	call   800cc8 <sys_getenvid>
  800130:	25 ff 03 00 00       	and    $0x3ff,%eax
  800135:	8d 04 40             	lea    (%eax,%eax,2),%eax
  800138:	c1 e0 05             	shl    $0x5,%eax
  80013b:	81 c0 00 00 c0 ee    	add    $0xeec00000,%eax
  800141:	89 06                	mov    %eax,(%esi)

	// save the name of the program so that panic() can use it
	if (argc > 0)
  800143:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  800147:	7e 08                	jle    800151 <libmain+0x49>
		binaryname = argv[0];
  800149:	8b 07                	mov    (%edi),%eax
  80014b:	89 83 0c 00 00 00    	mov    %eax,0xc(%ebx)
  ...
  800158:	e8 d6 fe ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  80015d:	e8 0b 00 00 00       	call   80016d <exit>
}
...
exit(void)
{
  ...
  800170:	53                   	push   %ebx
  800171:	83 ec 10             	sub    $0x10,%esp
  800174:	e8 8b ff ff ff       	call   800104 <__x86.get_pc_thunk.bx>
  800179:	81 c3 87 1e 00 00    	add    $0x1e87,%ebx
	sys_env_destroy(0);
  80017f:	6a 00                	push   $0x0
  800181:	e8 ed 0a 00 00       	call   800c73 <sys_env_destroy>
}
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800197:	e8 68 ff ff ff       	call   800104 <__x86.get_pc_thunk.bx>
  ...
  8001ad:	e8 16 0b 00 00       	call   800cc8 <sys_getenvid>
  8001b2:	83 ec 0c             	sub    $0xc,%esp
  8001b5:	ff 75 0c             	pushl  0xc(%ebp)
  8001b8:	ff 75 08             	pushl  0x8(%ebp)
  8001bb:	57                   	push   %edi
  8001bc:	50                   	push   %eax
  8001bd:	8d 83 f4 ef ff ff    	lea    -0x100c(%ebx),%eax
  8001c3:	50                   	push   %eax
  ...
  8001d0:	e8 63 00 00 00       	call   800238 <vcprintf>
	cprintf("\n");
  8001d5:	8d 83 c2 ef ff ff    	lea    -0x103e(%ebx),%eax
...
putch(int ch, struct printbuf *b)
{
  ...
  8001ec:	56                   	push   %esi
  8001ed:	53                   	push   %ebx
  8001ee:	e8 11 ff ff ff       	call   800104 <__x86.get_pc_thunk.bx>
  ...
  800227:	50                   	push   %eax
  800228:	e8 09 0a 00 00       	call   800c36 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800242:	e8 bd fe ff ff       	call   800104 <__x86.get_pc_thunk.bx>
  ...
  800289:	50                   	push   %eax
  80028a:	e8 a7 09 00 00       	call   800c36 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800312:	e8 d9 09 00 00       	call   800cf0 <__udivdi3>
  ...
  800355:	e8 b6 0a 00 00       	call   800e10 <__umoddi3>
  80035a:	83 c4 14             	add    $0x14,%esp
  80035d:	0f be 84 06 18 f0 ff 	movsbl -0xfe8(%esi,%eax,1),%eax
  800364:	ff 
  800365:	50                   	push   %eax
...
008003b2 <vprintfmt>:
{
  ...
  8003bb:	e8 44 fd ff ff       	call   800104 <__x86.get_pc_thunk.bx>
  ...
  80040b:	03 8c 83 a8 f0 ff ff 	add    -0xf58(%ebx,%eax,4),%ecx
...
008004c3 <.L32>:
  ...
  8004e0:	52                   	push   %edx
  8004e1:	8d 83 39 f0 ff ff    	lea    -0xfc7(%ebx),%eax
  8004e7:	50                   	push   %eax
  8004e8:	56                   	push   %esi
  ...
  8004fc:	50                   	push   %eax
  8004fd:	8d 83 30 f0 ff ff    	lea    -0xfd0(%ebx),%eax
  800503:	50                   	push   %eax
  800504:	56                   	push   %esi
...
00800518 <.L36>:
  ...
  800528:	8d 83 29 f0 ff ff    	lea    -0xfd7(%ebx),%eax
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  80084c:	e8 b3 f8 ff ff       	call   800104 <__x86.get_pc_thunk.bx>
...
sys_env_destroy(envid_t envid)
{
  ...
  800c77:	56                   	push   %esi
  800c78:	53                   	push   %ebx
  800c79:	83 ec 1c             	sub    $0x1c,%esp
  800c7c:	e8 66 00 00 00       	call   800ce7 <__x86.get_pc_thunk.ax>
  800c81:	05 7f 13 00 00       	add    $0x137f,%eax
  ...
  800ca0:	7f 08                	jg     800caa <sys_env_destroy+0x37>
  ...
  800cb0:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  800cb3:	8d 83 00 f2 ff ff    	lea    -0xe00(%ebx),%eax
  800cb9:	50                   	push   %eax
  800cba:	6a 23                	push   $0x23
  800cbc:	8d 83 1d f2 ff ff    	lea    -0xde3(%ebx),%eax
  800cc2:	50                   	push   %eax
  800cc3:	e8 c6 f4 ff ff       	call   80018e <_panic>
...
sys_getenvid(void)
{
  ...
  800cd3:	b8 02 00 00 00       	mov    $0x2,%eax
...
00800ce7 <__x86.get_pc_thunk.ax>:
  800ce7:	8b 04 24             	mov    (%esp),%eax
  800cea:	c3                   	ret    
