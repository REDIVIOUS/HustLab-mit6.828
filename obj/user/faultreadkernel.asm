	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025d:	0f be 84 06 bd ee ff 	movsbl -0x1143(%esi,%eax,1),%eax
  800264:	ff 
  800265:	50                   	push   %eax
...
008002b2 <vprintfmt>:
{
  ...
  80030b:	03 8c 83 4c ef ff ff 	add    -0x10b4(%ebx,%eax,4),%ecx
...
008003c3 <.L32>:
  ...
  8003e0:	52                   	push   %edx
  8003e1:	8d 83 de ee ff ff    	lea    -0x1122(%ebx),%eax
  8003e7:	50                   	push   %eax
  8003e8:	56                   	push   %esi
  ...
  8003fc:	50                   	push   %eax
  8003fd:	8d 83 d5 ee ff ff    	lea    -0x112b(%ebx),%eax
  800403:	50                   	push   %eax
  800404:	56                   	push   %esi
...
00800418 <.L36>:
  ...
  800428:	8d 83 ce ee ff ff    	lea    -0x1132(%ebx),%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bb3:	8d 83 a4 f0 ff ff    	lea    -0xf5c(%ebx),%eax
  800bb9:	50                   	push   %eax
  800bba:	6a 23                	push   $0x23
  800bbc:	8d 83 c1 f0 ff ff    	lea    -0xf3f(%ebx),%eax
  800bc2:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c18:	57                   	push   %edi
  800c19:	50                   	push   %eax
  800c1a:	8d 83 d0 f0 ff ff    	lea    -0xf30(%ebx),%eax
  800c20:	50                   	push   %eax
  ...
  800c2d:	e8 06 f5 ff ff       	call   800138 <vcprintf>
	cprintf("\n");
  800c32:	8d 83 f4 f0 ff ff    	lea    -0xf0c(%ebx),%eax
