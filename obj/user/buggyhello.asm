...
umain(int argc, char **argv)
{
  ...
  800049:	e8 92 00 00 00       	call   8000e0 <sys_cputs>
}
...
libmain(int argc, char **argv)
{
  ...
  80006e:	8b 7d 0c             	mov    0xc(%ebp),%edi
	...
	thisenv = 0;
  800071:	c7 c6 2c 20 80 00    	mov    $0x80202c,%esi
  800077:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	thisenv = (struct Env*)(envs + ENVX(sys_getenvid())); //（为当前进程）初始化全局指针
  80007d:	e8 f0 00 00 00       	call   800172 <sys_getenvid>
  ...
  800093:	89 06                	mov    %eax,(%esi)

	// save the name of the program so that panic() can use it
	if (argc > 0)
  800095:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  800099:	7e 08                	jle    8000a3 <libmain+0x49>
		binaryname = argv[0];
  80009b:	8b 07                	mov    (%edi),%eax
  80009d:	89 83 0c 00 00 00    	mov    %eax,0xc(%ebx)
...
exit(void)
{
  ...
  8000c6:	e8 8b ff ff ff       	call   800056 <__x86.get_pc_thunk.bx>
...
sys_env_destroy(envid_t envid)
{
  ...
  80015d:	8d 83 86 ee ff ff    	lea    -0x117a(%ebx),%eax
  800163:	50                   	push   %eax
  800164:	6a 23                	push   $0x23
  800166:	8d 83 a3 ee ff ff    	lea    -0x115d(%ebx),%eax
  80016c:	50                   	push   %eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80019e:	e8 b3 fe ff ff       	call   800056 <__x86.get_pc_thunk.bx>
  ...
  8001ac:	c7 c0 0c 20 80 00    	mov    $0x80200c,%eax
  ...
  8001c2:	57                   	push   %edi
  8001c3:	50                   	push   %eax
  8001c4:	8d 83 b4 ee ff ff    	lea    -0x114c(%ebx),%eax
  8001ca:	50                   	push   %eax
  ...
  8001d7:	e8 63 00 00 00       	call   80023f <vcprintf>
	cprintf("\n");
  8001dc:	8d 83 d8 ee ff ff    	lea    -0x1128(%ebx),%eax
...
putch(int ch, struct printbuf *b)
{
  ...
  8001f3:	56                   	push   %esi
  8001f4:	53                   	push   %ebx
  8001f5:	e8 5c fe ff ff       	call   800056 <__x86.get_pc_thunk.bx>
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800249:	e8 08 fe ff ff       	call   800056 <__x86.get_pc_thunk.bx>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800364:	0f be 84 06 da ee ff 	movsbl -0x1126(%esi,%eax,1),%eax
  80036b:	ff 
  80036c:	50                   	push   %eax
...
008003b9 <vprintfmt>:
{
  ...
  8003c2:	e8 8f fc ff ff       	call   800056 <__x86.get_pc_thunk.bx>
  ...
  800412:	03 8c 83 68 ef ff ff 	add    -0x1098(%ebx,%eax,4),%ecx
...
008004ca <.L32>:
  ...
  8004dc:	8b 94 83 10 00 00 00 	mov    0x10(%ebx,%eax,4),%edx
  8004e3:	85 d2                	test   %edx,%edx
  8004e5:	74 1c                	je     800503 <.L32+0x39>
				printfmt(putch, putdat, "%s", p);
  8004e7:	52                   	push   %edx
  8004e8:	8d 83 fb ee ff ff    	lea    -0x1105(%ebx),%eax
  8004ee:	50                   	push   %eax
  8004ef:	56                   	push   %esi
  ...
  800503:	50                   	push   %eax
  800504:	8d 83 f2 ee ff ff    	lea    -0x110e(%ebx),%eax
  80050a:	50                   	push   %eax
  80050b:	56                   	push   %esi
...
0080051f <.L36>:
  ...
  80052f:	8d 83 eb ee ff ff    	lea    -0x1115(%ebx),%eax
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  800853:	e8 fe f7 ff ff       	call   800056 <__x86.get_pc_thunk.bx>
